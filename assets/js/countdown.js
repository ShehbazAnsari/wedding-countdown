...
document.getElementById('hour').innerHTML = `<div class="spinner-border text-brown" role="status">
  <span class="sr-only">Loading...</span>
</div>`
document.getElementById('minute').innerHTML = `<div class="spinner-border text-warning" role="status">
  <span class="sr-only">Loading...</span>
</div>`
document.getElementById('second').innerHTML = `<div class="spinner-border text-brown" role="status">
  <span class="sr-only">Loading...</span>
</div>`
